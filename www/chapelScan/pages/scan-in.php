...
$results = mysqli_query($connect, "SELECT * FROM scans ORDER BY CREATED_AT DESC");
?>
<!DOCTYPE html>
<html lang="en">
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <!-- Scan in area -->
        <div class="row">
            <form method="POST" action="../function/send_post.php" onsubmit="setTimeout(function () { window.location.reload(); }, 10)">

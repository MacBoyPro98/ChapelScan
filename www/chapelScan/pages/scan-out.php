...
$results = mysqli_query($connect,"SELECT * FROM current_scans WHERE UPDATED_AT != 'NULL' ORDER BY CREATED_AT DESC LIMIT 1");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Scan-Out</h1>
                </div>
            </div>
            <!-- Scan out area -->
            <div class="row">
                <form method="POST" action="../function/send_update.php" onsubmit="setTimeout(function () { window.location.reload(); }, 10)">
